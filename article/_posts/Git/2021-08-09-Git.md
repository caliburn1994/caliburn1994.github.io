...
![image-20210905181306041](/assets/blog_res/git/image-20210905181306041.png)

使用 notepad++ 当编辑器

![image-20210905181329148](/assets/blog_res/git/image-20210905181329148.png)

一个新 repository 默认分支叫什么名称。Github 用的是 main，git 默认的是 master。相关讨论参考[此处](https://stackoverflow.com/questions/64249491/difference-between-main-branch-and-master-branch-in-github)。

![image-20210905181548737](/assets/blog_res/git/image-20210905181548737.png)
...
![image-20210905181838058](/assets/blog_res/git/image-20210905181838058.png)

当 `git pull` 发生冲突时，选择的策略：

1. merge
2. rebase
3. 什么都不做

这里选择 rebase ，只进行一次 merge。多次 merge 意义不大。![image-20210906011444172](/assets/blog_res/git/image-20210906011444172.png)

credential helper（存储凭证的工具）

![image-20210906011820957](/assets/blog_res/git/image-20210906011820957.png)
...
1. 通过 PuTTY 生成 public key 和 private key
   ...
   ![image-20210905173316191](/assets/blog_res/git/image-20210905173316191.png)

   保存 OpenSSH 格式的 private key 至 `~/.ssh/github.ppk`

   ![image-20210911160748728](/assets/blog_res/git/image-20210911160748728.png)

   复制 OpenSSH 格式的 public key 

   ![img](/assets/blog_res/git/4947h.png)
...
3. SSH-agent 添加 private key
   ...
   ![image-20210905173445773](/assets/blog_res/git/image-20210905173445773.png)
...
![img](/assets/blog_res/git/Git-Rebase.png)
